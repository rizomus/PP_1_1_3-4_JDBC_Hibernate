...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void createUsersTable() {
        ...
        Connection con = null;
        try {
            con = DriverManager.getConnection(host, "root", "synchro4");
    ...
    public void dropUsersTable() {
        ...
        Connection con = null;
        try {
            con = DriverManager.getConnection(mysqlUrl, "root", "synchro4");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        Statement stmt = null;
    ...
    public void saveUser(String name, String lastName, byte age) {
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO usersTable (name, lastName, age) VALUES (?, ?, ?);");
    ...
    public void removeUserById(long id) {
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM usersTable WHERE id = ?");
    ...
    public List<User> getAllUsers() {
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM usersTable");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        try {
    ...
    public void cleanUsersTable() {
        ...
        try {
            stmt = con.prepareStatement("TRUNCATE TABLE usersTable");
